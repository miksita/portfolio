...
<div className="flex md:flex md:flex-grow flex-row justify-end space-x-1">
  ...
  <a href="" className="py-4 px-2 text-gray-500 font-semibold hover:text-teal-300 transition duration-300">Contact Us</a>
      ...
      <p className="text-8xl">GEGEGEGEGEGEGGEG</p>
  ...
  <h3 className="text-gray-900 dark:text-white mt-5 text-base font-medium tracking-tight ">АААААААААААА</h3>
  <p className="text-gray-500 dark:text-gray-400 mt-2 text-sm ">бал бла бала абла абала абла аблабаблабалаблал
  </p>
</div>

{/* 
<nav> x-data="{ isOpen: false }" className="bg-white shadow dark:bg-gray-800"<nav>
